...
class UserSettingsRepository:
    ...
    async def get(self, **kwargs) -> UserSettings:
        return await self.model.get(**kwargs)

    async def filter(self, **kwargs) -> QuerySet:
        return self.model.filter(**kwargs)

    async def update(self, instance: UserSettings, **kwargs) -> None:
        await instance.update_from_dict(kwargs)

    async def delete(self, instance: UserSettings) -> None:
    ...
    async def to_pydantic(self, instance: UserSettings):
        return await pydantic_model_creator(UserSettings)(instance)
